...
@property (nonatomic, retain) NSString            *login_id;          //登录id
...
//微信
@property (nonatomic,copy   ) NSString            *uid;               //微信id
@property (nonatomic,copy   ) NSString            *nickname;          //微信用户昵称
@property (nonatomic,copy   ) NSString            *gender;            //微信用户性别
@property (nonatomic,copy   ) NSString            *icon;              //微信用户头像
