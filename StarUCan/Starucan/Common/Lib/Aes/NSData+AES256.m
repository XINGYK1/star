...
/*加密方法*/
+ (NSString *)AES256EncryptWithPlainText:(NSString *)plain passtext:(NSString *)text{
	...
	CCCryptorStatus cryptStatus = CCCrypt(kCCEncrypt, kCCAlgorithmAES128,kCCOptionPKCS7Padding,
                                          [[NSData AESKeyForPassword:text] bytes], kCCKeySizeAES256,
...
/*解密方法*/
+ (NSString *)AES256DecryptWithCiphertext:(NSString *)ciphertexts passtext:(NSString *)text{
